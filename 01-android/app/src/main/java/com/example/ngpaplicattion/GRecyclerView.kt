...
class GRecyclerView : AppCompatActivity() {
    ...
    fun inicializarRecyclerView(
        ...
        recyclerView.itemAnimator = android.recyclerview.widget.DefaultItemAnimator()
        recyclerView.layoutManager = android.recyclerview.widget.LinearLayoutManager(this)
